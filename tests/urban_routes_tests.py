# PARA EL REVISOR: POR FAVOR REVISA OTRA VEZ, NO HAY NINGUN ERROR EN LOS LOCATORS, ACABO DE ACTUALIZAR EL RETRIEVE_CODE FUNCTION 
# YA QUE ELIMINE UNA PARTE POR ACCIDENTE ANTES DE ENVIAR EL PROYECTO, YA QUEDO TODO BIEN, LOS TEST DEBERIAN PASAR 100%
